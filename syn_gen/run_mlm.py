from transformers import RobertaTokenizer, RobertaForMaskedLM, BertTokenizer, BertForMaskedLM, AdamW, get_linear_schedule_with_warmup
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained-model", type=str, default='roberta-base', help='pretrained model for MLM')
